                            ...
                            case 1:
                                ...
                                switch (choice11) {
                                    case 1:
                                        ...
                                        int count = RiR.updateRIResidentPhoneNumberUsingResidentId(rid,
                                                contactNumber);
                                        if (count == 1) {
                            ...
                            case 2:
                                ...
                                switch (choice12) {
                                    case 1:
                                        ...
                                        int count3 = RiR.updateOccupancyUsingResidentId(adults_a, child_12_a,
                                                child_5_a, rid1);
                                        if (count3 == 1) {
...
//                    }
                        ...
                        if (a == 1) {
                            System.out.println("RIResident table with respective Resident ID has been deleted successfully");
                        }
                        else {
